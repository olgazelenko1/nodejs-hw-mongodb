...
import { contactSchema } from "../validation/students.js";
...
router.post('/contacts', validateBody(contactSchema), createContactController); 
router.delete('/contacts/:id',isValidId, deleteContactControler);
router.patch('/contacts/:id',isValidId,validateBody(contactSchema), updateContactController);